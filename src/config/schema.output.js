    ...
    chat_messages: {
      ...
      id_user: {
        ...
        schema: {
          ...
          $isUnsigned: 0,
          $isAutoIncrement: 0,
          $boundConstraint: 'chat_messages_ibfk_1',
    ...
    example_process: {
      ...
      id_creator: {
        ...
        schema: {
          ...
          $isUnsigned: 0,
          $isAutoIncrement: 0,
          $boundConstraint: 'example_process_ibfk_1',
          $referencedTable: 'users',
          $referencedColumn: 'id'
        }
      },
      ...
      status: {
        ...
        schema: {
          ...
          $table: 'example_process',
          $column: 'status',
          $columnType: 'enum(\'hello\',\'conversation\',\'good-bye\')',
          $isColumnNullable: 'YES',
          $defaultColumnValue: null,
          $extraColumnInformation: '',
          $ordinalColumnPosition: 5,
          $maximumCharactersLength: 12,
          $isUnsigned: 0,
          $isAutoIncrement: 0,
          $boundConstraint: null,
          $referencedTable: null,
    ...
    example_process_transaction: {
      ...
      id_process: {
        ...
        schema: {
          ...
          $isUnsigned: 0,
          $isAutoIncrement: 0,
          $boundConstraint: 'example_process_transaction_ibfk_1',
    ...
    filesystem: {
      ...
      nodetype: {
        ...
        schema: {
          ...
          $table: 'filesystem',
          $column: 'nodetype',
          $columnType: 'enum(\'branch\',\'leaf\')',
          $isColumnNullable: 'YES',
          $defaultColumnValue: null,
          $extraColumnInformation: '',
          $ordinalColumnPosition: 2,
          $maximumCharactersLength: 6,
          $isUnsigned: 0,
          $isAutoIncrement: 0,
          $boundConstraint: null,
          $referencedTable: null,
