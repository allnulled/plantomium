...
class JSONStoreController {
	...
	mountToRouter(app) {
		app.get(this.path, this.onGet.bind(this));
		app.post(this.path, cms.rest.middlewares.postify, this.onSet.bind(this));
		app.delete(this.path, cms.rest.middlewares.postify, this.onDelete.bind(this));
	}
