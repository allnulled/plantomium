...
const up = path.resolve(__dirname + "/../scripts/migrations/authentication.ejs.sql");
const down = path.resolve(__dirname + "/../scripts/migrations/authentication.undo.ejs.sql");
